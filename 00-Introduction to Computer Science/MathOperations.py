...
for i in range(
    5
):  # Run a loop statement to pick 5 random numbers from 0 to 1.00 and print them in different lines.
    print(round(random.random(), 5))
print()
print("11.")
for i in range(10):
    print(
        random.randint(15, 50), end=" "
    )  # end = ' ' makes so that all the random picked numbers stay in the same line.
print()
print()
print("12.")
for i in range(10):
