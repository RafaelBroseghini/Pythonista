    ...
    def run_machine(self, inputString):
        ...
        while key in self.delta and not reached_final:
            ...
            if goTo in self.finalStates:
                print('The turing machine has reached a final state:', goTo)
                print()
                print('Reversed tape:',tape)
                reached_final = True
...
def main(): 
    ...
    # Used morphetts website to help on the state building proccess.
