...
def main():
    ...
    print('The right child of the root of the MorseTree is:', morse_code_tree.getRightChild())
    print('The left child of the root of the MorseTree is:', morse_code_tree.getLeftChild())
    print('The right child of', morse_code_tree.getRightChild(), 'is:', morse_code_tree.getRightChild().getRightChild())
    print('The left child of', morse_code_tree.getLeftChild(), 'is:', morse_code_tree.getLeftChild().getLeftChild())
