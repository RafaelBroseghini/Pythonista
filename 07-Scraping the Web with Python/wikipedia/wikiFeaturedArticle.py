...
def displayPictureInfo(title,lst):
    print("\033[1;31mToday's Featured Picture on the Wikipedia (English) Main Page is: {} \033[0m\n".format(title[0].text))
    print("\033[1;36mDescription:\033[0m\n")
    print(lst[0].text)

def displayFunFactsInfo(lst):
    print("\033[1;31mToday's 'Did you know' questions on the Wikipedia (English) Main Page are: \033[0m\n")
...
def displayArticleInfo(lst):
    print("\033[1;31mToday's Featured Article on the Wikipedia (English) Main Page is: \033[0m\n")
    print("\033[1;36mDescription:\033[0m\n")
    print(lst[0].text)
