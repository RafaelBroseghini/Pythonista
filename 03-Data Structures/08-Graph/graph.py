class Vertex:
    ...
    # Get all neighbors keys. Str type. Method can be changed to return list
    # with nbrs.
...
class Graph:
    def __init__(self):
        # Dictionary with all vertices in graph as keys and their
        # dict(neighbors: distance) as valuee.
        self.vertList = {}
        self.numVertices = 0
